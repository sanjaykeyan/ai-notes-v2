...
// Remove MeetingShareButton import
              ...
              {[
                {
                  ...
                  description: "Upload your meeting recording in MP3 or MP4 format",
                  icon: "📤",
                ...
                <div key={item.step} className="relative group hover:scale-105 transition-transform duration-300">
                  <div className="text-center">
                    <div className="relative">
                      ...
                      <div className="absolute -top-1 -right-1 w-4 h-4 rounded-full bg-white dark:bg-gray-800 
        ...
        <div className="lg:w-[30%]">
          <div className="bg-white/80 dark:bg-gray-800/50 backdrop-blur-sm rounded-2xl shadow-lg p-6 sticky top-[5rem] h-full border border-gray-100 dark:border-gray-700">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100">Recent Meetings</h2>
              <span className="text-sm text-gray-500 dark:text-gray-400">{recentMeetings.length} total</span>
            </div>
                ...
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                    {recentMeetings.map((meeting) => (
                      <tr key={meeting.id} className="group hover:bg-gray-50/50 dark:hover:bg-gray-700/50">
                        <td className="py-3">
